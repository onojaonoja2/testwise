...
export default function DashboardPage() {
  ...
  const creatorLinks = [
    { to: '/dashboard/tests', label: 'My Tests' },
    // { to: '/dashboard/results', label: 'Results' }, // Future link
  ];

  const takerLinks = [
    { to: '/dashboard/available-tests', label: 'Available Tests' },
    // { to: '/dashboard/my-sessions', label: 'My History' }, // Future link
  ];

  // Determine which links to show
  const navLinks = user?.role === 'Test Creator' ? creatorLinks : takerLinks;
